...
<div class="flex w-full items-stretch border-2 border-border bg-bg rounded-md p-1">
  <button onclick={() => changeValue(-1)} class="bg-surface text-text-dim hover:text-text-bright hover:bg-border size-9 rounded-sm flex justify-center text-lg items-center cursor-pointer active:scale-95 duration-100">
    -
  </button>
