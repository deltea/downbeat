...
theme.subscribe(value => {
  ...
  // document.body.style.setProperty("--color-accent", t.surfaceLight);
  // document.body.style.setProperty("--color-accent", t.surface0);
  // document.body.style.setProperty("--color-accent", t.fg);
  // document.body.style.setProperty("--color-text", t.muted);
